    ...
    <div className="min-h-screen">
      ...
      <section className="relative py-20 px-4 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto text-center relative z-10">
          ...
          <div className="bg-orange-50 p-6 rounded-lg border-l-4 border-orange-600 mb-8 max-w-4xl mx-auto">
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Why Our Stories Are Different</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="text-center group hover:shadow-lg transition-shadow">
              <CardContent className="p-6">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-2">Authentic & Raw</h3>
            ...
            <Card className="text-center group hover:shadow-lg transition-shadow">
              <CardContent className="p-6">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-2">Untold Struggles</h3>
                <p className="text-gray-600">
            ...
            <Card className="text-center group hover:shadow-lg transition-shadow">
              <CardContent className="p-6">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-2">Immersive Experience</h3>
                <p className="text-gray-600">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4 flex items-center justify-center">
              <Scroll className="h-8 w-8 mr-3 text-orange-600" />
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Types of Warriors</h2>
            <p className="text-lg text-gray-600">
